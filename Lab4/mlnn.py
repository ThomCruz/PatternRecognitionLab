...
n_hidden1 = 32  # 1st hidden layer
n_hidden2 = 32  # 2nd hidden layer
n_hidden3 = 32  # 3rd hidden layer
n_hidden4 = 32  # 4th hidden layer
n_hidden5 = 32  #5th hidden layer
...
layer_3 = tf.nn.relu(layer_3, name ='ReLU')
layer_4 = tf.add(tf.matmul(layer_3, weights['w4']), biases['b4'])
layer_4 = tf.nn.relu(layer_4, name ='ReLU')
layer_5 = tf.add(tf.matmul(layer_4, weights['w5']), biases['b5'])
layer_5 = tf.nn.relu(layer_5, name ='ReLU')
layer_drop = tf.nn.dropout(layer_5, keep_prob)
output_layer = tf.matmul(layer_5, weights['out']) 
